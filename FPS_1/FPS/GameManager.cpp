...
Object* GameManager::AddBomb(int a_nPlayerX, int a_nPlayerY)		//6_폭탄 추가 함수.
{
...
void GameManager::ResistExplosion(Object* a_refBomb,  int x, int y, int pow)		//6_폭발 저항?
{
	m_pPlayer->ResetBomb(a_refBomb);											//놔둔 폭탄 숫자 하나 감소.
